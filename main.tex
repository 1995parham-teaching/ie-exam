...
\exam{آزمون پایانی}
\semester{نیم سال دوم ۱۳۹۹-۱۴۰۰}
\duration{۱۵۰}
...
\begin{document}
  ...
  \pagebreak
  \subfile{auth/main}
  \subfile{context-in-echo/main}
  \subfile{proxies/main}
  \subfile{host-header/main}
  \subfile{learn-in-c/main}
  \subfile{js-event-2/main}
  \subfile{cap/main}
  \subfile{vm-vs-docker/main}
  \vspace*{\fill}
  \begin{center}
